defmodule CubepubWeb.Router do
  use CubepubWeb, :router

  pipeline :browser do
    plug :accepts, ["html"]
    plug :fetch_session
    plug :fetch_live_flash
    plug :put_root_layout, html: {CubepubWeb.Layouts, :root}
  ...
  if Application.compile_env(:cubepub_web, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: CubepubWeb.Telemetry
